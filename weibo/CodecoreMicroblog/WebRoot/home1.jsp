...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="menu">
        ...
        <!-- weibo 开始-->
        <%
        	ArrayList<Blog> lstBlogs=(ArrayList<Blog>) session.getAttribute("list");
          ...
          <tr>
            <td height="25"><table width="100%" border="0" cellpadding="0" cellspacing="0" id="weibo_status">
              <tr>
                ...
                <td align="right"><a style="text-decoration: none" href="<%=request.getContextPath()%>/DispatchBlogServlet?bid=${blogs.b_id}">转发(${blogs.b_degree})</a> 
                &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="<%=request.getContextPath()%>/servlet/AddCollectServlet?bid=${blogs.b_id}&type=home" style="text-decoration: none">收藏</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
	...
	<table align="center" id="page">
      ...
      <tr>
        <td align="right"><a style="text-decoration: none" href="<%=request.getContextPath()%>/ShowAttentionBlogServlet?pageNumber=1">首页</a>&nbsp;
           ...
           &nbsp;<c:choose>
           			...
           			<c:otherwise>
           				<a style="text-decoration: none" href="<%=request.getContextPath()%>/ShowAttentionBlogServlet?pageNumber=${pageNumber+1}">下一页</a>
           			</c:otherwise>
           		</c:choose>
	</td>
      </tr>
