...
<table border="0" align="center" cellpadding="0" cellspacing="0" id="container">
  <tr>
    <td width="670" height="600" valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" id="curruser">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="menu">
          <tr>
            ...
            <td width="49%" align="center"><form id="form1" name="form1" method="post" action="servlet/SearchProfileServlet">
   ...
   <%
	      ...
	      if(session.getAttribute("blogList")!=null){
	      		mybloglist  = (List<Blog>) session.getAttribute("blogList");	
          ...
          <tr>
            <td height="25"><table width="100%" border="0" cellpadding="0" cellspacing="0" id="weibo_status" >
              <tr>
                ...
                <td align="right" ><a href="<%=request.getContextPath()%>/DeleteBlogServlet?bid=${myblog.b_id}" style="text-decoration: none;color:#09C">删除</a>
                 &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="<%=request.getContextPath()%>/servlet/AddCollectServlet?bid=${myblog.b_id}&type=profile" style="text-decoration: none;color:#09C">收藏</a>
                </td>
              </tr>
            </table></td>
          </tr>
...
<table align="center" id="page">
	<form action="/CodecoreMicroblog/PageServlet?pageNumber=1" id="navigatorForm">
      <tr>
        <td align="right"><a style="text-decoration: none;color:#09C" href="<%=request.getContextPath()%>/PageServlet?pageNumber=1">首页</a>&nbsp;
           ...
           &nbsp;<a style="text-decoration: none;color:#09C" href="<%=request.getContextPath()%>/PageServlet?pageNumber=${p_pageNumber+1}">下一页</a>
	   </td>
      </tr>
      </form>
    </table>
