  ...
  <tr>
    <td width="670" height="600" valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" id="curruser">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="menu">
        ...
        <!-- weibo 开始-->
   <%
        	ArrayList<Collect> lstCollects=(ArrayList<Collect>) session.getAttribute("listAllCollect");
        	Iterator it=lstCollects.iterator();
        	while(it.hasNext()){
       ...
       <table id="weibo" width="90%" border="0" align="center" cellpadding="3" cellspacing="0">
          ...
          <tr>
            <td><%if(collect.getCo_img()!=null){%>
            	<img src="${collect.co_img}" width="89" height="120"  name="image1" id="imgid${blogs.b_id}" style="cursor:url(mouse/0001.ani)"   onclick="bigsmall(${blogs.b_id})" />
           <% } %></td>
          </tr>
          <tr>
            <td height="25"><table width="100%" border="0" cellpadding="0" cellspacing="0" id="weibo_status">
              <tr>
                ...
                <td align="right" class="content"><a style="text-decoration: none" href="<%=request.getContextPath()%>/servlet/CancelCollectServlet?co_id=${collect.co_id}"> 取消收藏</a> </td>               
              </tr>
            </table></td>
          </tr>
    	</table>
